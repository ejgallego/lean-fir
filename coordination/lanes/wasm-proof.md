...
files: integration/talos/FirTalos/ConcreteResidentMemory.lean; integration/talos/FirTalos/ConcreteResidentUSize.lean; integration/talos/W6-COVERAGE.md; integration/talos/W6-THEOREM-ROADMAP.md; coordination/lanes/wasm-proof.md; plus the preceding stacked Nat-decision files already reported at ad30850b
...
handoff: Ready green stacked W6 proof candidate at functional head 56c6e99c, rebased on main 4fea3692. Integration may add `import FirTalos.ConcreteResidentNatDecision` and `import FirTalos.ConcreteResidentUSize` to its umbrella, rerun the gates, and fast-forward the three-commit stack. The USize slice proves the actual immediate helper completely and the actual checked outer helper against the stable concrete numeric call boundary, including exact modulo-2^64 semantics and scratch restoration.
