...
contract-base: 904ec391; proof-only extension over the accepted exact saturated-closure dispatch prefix and existing concrete capture-projection/argument contracts
...
bug-cards: none
blockers: none
handoff: ready; fast-forward main from 904ec391 through functional head 1e49bef7 and this containing mailbox status commit.
