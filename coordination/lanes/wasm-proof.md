...
bug-cards: none
blockers: none
handoff: none; the hereditary saturated-call slice landed on main at fc5c07f5 and the lane is active on the compiler-produced export/finite-trace boundary.
