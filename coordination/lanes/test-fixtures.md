...
handoff: integration may land branch validation/closure-ownership-fixtures through functional head 072e90d73288ccde574cf93766643af4ab0ea121 plus this ready mailbox commit; base and contract base 43a5c14e23b227f8ff54d874d9f6b24ec3d65119
next: after integration, select the smallest undominated memory-lifetime interaction outside the covered replacement/release matrix; keep native Lean as the admission oracle
```
