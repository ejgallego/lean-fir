...
handoff: the integration owner may land functional head 0fec2b0f1759224c811e024489604edfcd9c04cd plus this clean ready mailbox commit as the S2 fixture/trace/oracle/coverage/documentation stack based directly on 2d96f7a1; no W6, W7, LCNF-proof, or shared-contract file changes
next: integrate S2 promptly, then execute S3 capture alias topology with repeated captures, an independent outside alias, and action-sensitive ignore/read/return/consume pairs
```
