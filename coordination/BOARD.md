...
- `USIZE-BOXING-UPSTREAM-ALIGNMENT` is an active isolated contract candidate
  on base `3b96b2b3`: bug-card commit `93ed2510` precedes semantic/fixture head
  `73eb55cc`. It aligns FIR with upstream `lean_box_usize` /
