# Pass-correctness history through 2026-08-30

This file preserves the detailed landed-proof chronology and the planning
snapshot that existed at `main` commit `91b2f3ac`. It is evidence and design
history, not a live backlog. Any statement below named "next", "remaining",
or "immediate" is historical and is superseded by
[`pass-correctness-plan.md`](pass-correctness-plan.md).

`docs/research.md` supplies broader rationale, while `docs/lcnf-to-c.md`
supplies the compiler-pipeline reference.
