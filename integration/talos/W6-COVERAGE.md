...
- compiler-level coverage is now tracked separately from operation coverage.
  ...
  zero-token allocation. Structural whole-export composition now waits on
  stable ordinary-token validation
