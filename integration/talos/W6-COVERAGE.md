...
- lazy-cache hits and misses compose through the exact compiler/adapter shape,
  ...
  declaration bodies still need to instantiate that package; scalar,
  erased/reuse, direct-tag, promoted-tag, and ordinary boxed/natural/string
  leaf roots discharge cache persistence constructively;
