...
- the frozen UTF-8 string writer has exact byte readback and spatial-frame
  ...
  `StringObjectRel`, while descriptor and `LiveHeapRel` integration remain
  explicit follow-ups;
