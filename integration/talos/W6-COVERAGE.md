...
- effect families now compose rather than remaining isolated endpoints:
  ...
  FVar object-field mutation now joins it with descriptor existence recovered
  from the runtime relation and only slot-kind agreement left as a source
  typing premise; and
