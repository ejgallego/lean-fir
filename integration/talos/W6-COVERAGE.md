...
|---|---|---|---|---|
| `literal` | Naturals only | Tagged encoder and large-natural heap theorem | Partial | Natural concrete host plus generated literal-`let` WP, whole-module concrete Talos execution, and Node/V8 plus browser-Worker concrete-word execution; strings missing |
...
- a browser-safe external-engine host now mirrors the proved concrete word,
  ...
  allowlist leaves strings, externals, and initial heaps to subsequent slices;
  and
