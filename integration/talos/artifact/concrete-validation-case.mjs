...
export const CONCRETE_VALIDATION_BLOCKED_CASES = Object.freeze([
  ...
  "byte-array-size",
  "captured-byte-array-outside-alias-byte-read",
  "captured-byte-array-outside-alias-mutation",
  "captured-byte-array-outside-alias-read",
  "captured-dictionary-retained-observer",
  "captured-dictionary-unique-final-mutation",
  ...
  "effect-record-nested-aliased-byte-array-mixed-layout",
