...
source_artifact="$here/_build/source-pretty-format-trace-resident-naturals.wasm"
...
const build = {
  ...
  runtime: "Wasm-resident allocator/raw stores/constructors/immediate Naturals plus concrete JavaScript wasm32-lean64 handlers",
  test: "node smoke.mjs",
};
fs.writeFileSync(
