...
test -s "$here/_build/resident-cache.wasm"
test -s "$here/_build/resident-cache.wasm.json"
test -s "$here/_build/resident-numeric.wasm"
test -s "$here/_build/resident-numeric.wasm.json"
test -s "$here/_build/resident-string.wasm"
test -s "$here/_build/resident-string.wasm.json"
test -s "$here/_build/resident-fallbacks.wasm"
test -s "$here/_build/resident-fallbacks.wasm.json"
...
test -s "$here/_build/source-pretty-format-resident-cache.wasm"
test -s "$here/_build/source-pretty-format-resident-cache.wasm.json"
test -s "$here/_build/source-pretty-format-resident-numeric.wasm"
test -s "$here/_build/source-pretty-format-resident-numeric.wasm.json"
test -s "$here/_build/source-pretty-format-resident-string.wasm"
test -s "$here/_build/source-pretty-format-resident-string.wasm.json"
test -s "$here/_build/source-pretty-format-resident-closed.wasm"
test -s "$here/_build/source-pretty-format-resident-closed.wasm.json"
...
test -s "$here/_build/source-pretty-format-trace-resident-cache.wasm"
test -s "$here/_build/source-pretty-format-trace-resident-cache.wasm.json"
test -s "$here/_build/source-pretty-format-trace-resident-numeric.wasm"
test -s "$here/_build/source-pretty-format-trace-resident-numeric.wasm.json"
test -s "$here/_build/source-pretty-format-trace-resident-string.wasm"
test -s "$here/_build/source-pretty-format-trace-resident-string.wasm.json"
test -s "$here/_build/source-pretty-format-trace-resident-closed.wasm"
test -s "$here/_build/source-pretty-format-trace-resident-closed.wasm.json"
