...
kind before the concrete slot writer updates the heap. Remaining construction
slices connect erased-object, `USize`, and packed-scalar field mutations,
