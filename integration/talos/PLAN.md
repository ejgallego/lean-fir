...
zero is justified only by the erased ABI relation. Remaining construction
slices connect `USize` and packed-scalar field mutations, saturated-closure
