...
and the same heap-effect reconstruction restores the recursive frame. Remaining
construction slices connect object/`USize`/packed-scalar field mutations,
