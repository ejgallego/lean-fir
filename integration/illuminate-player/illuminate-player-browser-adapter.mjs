...
export const ILLUMINATE_PLAYER_RUNTIME_VERSION =
...
function runtimeHeapBase(manifest, build) {
  ...
  requireCondition(descriptorRuntime.version === ILLUMINATE_PLAYER_RUNTIME_VERSION,
    "resident-runtime version is unsupported");
  requireCondition(descriptorRuntime.provider === "none" &&
    buildRuntime.provider === "none",
  "player package must not declare an external runtime provider");
  ...
  "player package must not declare external runtime operations");
