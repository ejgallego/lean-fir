...
/--
SHA-256 of `Lean/Compiler/LCNF/AlphaEqv.lean` in the pinned Lean 4.33.0
toolchain. This records the exact source audited when introducing the bridge.
-/
def lean433AlphaEqvSourceSha256 : String :=
  "f62bf73971d21483f1e285ecc74980bdc12baa0bf5c494fed4dc5d021aeded43"

/--
Trusted correspondence between Lean 4.33's opaque `partial def` and FIR's
...
-/
axiom lean433UpstreamBridge : UpstreamBridge
...
theorem localAccepts_of_upstream
  ...
  lean433UpstreamBridge.accepted left right accepted
...
/--
Compiler-facing terminal soundness using the single Lean-4.33 trust axiom.
...
theorem trustedAlphaEqvSoundAt_of_local_terminal_sound
  ...
  alphaEqvSoundAt_of_local_terminal_sound lean433UpstreamBridge localSound
